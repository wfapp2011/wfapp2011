...
/**
 * ProposalsMain is the entry point class.
 * It defines <code>onModuleLoad()</code>.
 * This class creates the page structure 
 * and manages the subpages.
 * 
...
public class ProposalsMain implements EntryPoint {
	...
	// string constants
	private String PHASE_NAME = "Themenerfassung";
	private String M_HOME = "Home";
	private String M_NEWPROPOSAL = "neuer Vorschlag";
	private String M_OWNPROPOSALS = "eigene Themenvorschläge";
	private String M_ALLPROPOSALS = "alle Themenvorschläge";
	private String L_LOGIN = "Login";
	private String L_LOGOUT = "Logout";
	...
	public void onModuleLoad() {
		...
		//enable this, to initialite metatables and
		//to insert departments and persons
		//setupTestdata();
 	...
 	private void createHeader() {	
		...
		menuItem_Home.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				// TODO switch to process overview
			}
		});
	...
	private void setupTestdata(){
		...
		// callback (when initializeMetadata returned successfully)
	}
