...
/**
 * ListOfAllProposals is a subpage of ProposalsMain.
 * It renders public project proposals from all departments.
 * 	 
...
public class ListOfAllProposals extends Composite {
	...
	public void renderProposals(){		
		...
		HTMLPanel titlePanel = new HTMLPanel("<h3>Projektvorschläge aller Fachbereiche</h3>");
