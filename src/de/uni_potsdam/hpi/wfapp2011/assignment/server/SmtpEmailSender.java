...
public class SmtpEmailSender{
  ...
  public void sendMultipleEmails(String[] receiverAddressList, String[] receiverNames,
			String subject, String msgBody)
			throws UnsupportedEncodingException{
...
//			String[] nameList = reciverNames.split(";");
			for (int i=0; i<receiverAddressList.length; i++) {
				msg.addRecipient(Message.RecipientType.TO,
		                new InternetAddress(receiverAddressList[i], receiverNames[i]));
			}
