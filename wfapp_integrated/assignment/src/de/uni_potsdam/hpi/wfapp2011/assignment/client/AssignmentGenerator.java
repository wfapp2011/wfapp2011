	...
	private void createSaveButton(final HorizontalPanel assignmentMenuPanel) {
		...
		btnSave.addClickHandler(new ClickHandler(){
	        public void onClick(ClickEvent event){
	        	...
	        	AP5_main.assignmentDataInterface.writePlacements(AP5_main.DBStudents,AP5_main.type, AP5_main.semester, AP5_main.year, new AsyncCallback<Void>() {
				...
				ClickListener ConfirmListener = new ClickListener(){
					public void onClick(Widget sender){
						...
						for(Project p : AP5_main.DBProjects){
							...
							AP5_main.assignmentDataInterface.sendAssignment(studsInP, AP5_main.type, AP5_main.semester, AP5_main.year, new AsyncCallback<Void>() {
								public void onFailure(Throwable caught) {
