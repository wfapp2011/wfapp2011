 ...
 *
 */
public class ProposalCollection implements JavaDelegate{
	 ...
	 * It will set the phase variable in activiti to the name of the current phase (Proposal Collection).
	 */
	@Override
	public void execute(DelegateExecution execution) throws Exception {
		String deadline = (String)execution.getVariable(Constants.DEADLINE_PROPOSAL_COL_INPUT);
		execution.setVariable(Constants.CHANGED_VARIABLE, 0);
		execution.setVariable(Constants.DEADLINE_PROPOSAL_COL, deadline);
		execution.setVariable(Constants.PROCESS_PHASE, Constants.PROPOSALCOL);
	}
}
