...
public class TableCreator {
	...
	public void create(){
		try{
			...
			stmt.executeUpdate("CREATE TABLE person (personID INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255), email VARCHAR(255), role VARCHAR(255), department INT, placement VARCHAR(255));");
