...
public class DetailedViewProposal extends Composite {
	...
	VerticalPanel vp_title;
	VerticalPanel vp_proposal;
	VerticalPanel vp_edit;
	VerticalPanel vp_lastModified;
	VerticalPanel vp_comments;
	...
	private void renderContentOnFailure(){
		...
		HTMLPanel txt_info  = new HTMLPanel("Beim Laden des Projektvorschlags ist ein Fehler aufgetreten. <br> Bitte versuchen Sie es erneut.");		
		Button btn_tryAgain = new Button("Erneut versuchen");	
	...
	private VerticalPanel createProposalPanel(){		
		...
		// HEADLINES
		HTMLPanel headline_projectDescription = new HTMLPanel("Projektbeschreibung");
		HTMLPanel headline_partner =  new HTMLPanel("<br> Projektpartner: "+proposal.getPartnerNameOr(""));
		HTMLPanel headline_basicInfo  = new HTMLPanel("<br> Eckdaten");
		HTMLPanel headline_contact = new HTMLPanel("<br> Ansprechpartner");
	...
	private VerticalPanel createEditPanel() {
		...
		Button btn_edit = new Button("Projekt editieren");
		Button btn_createPDF = new Button("PDF erzeugen");
	...
	private VerticalPanel createCommentsPanel() {
		...
		HTMLPanel commentsInfo = new HTMLPanel("<b>Kommentare</b>");
		...
		Button btn_submitComment = new Button("abschicken");
