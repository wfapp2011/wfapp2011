package de.uni_potsdam.hpi.wfapp2011.admin.server;
...
public class ConfigInterfaceDataExchangeImpl extends RemoteServiceServlet implements ConfigInterfaceDataExchange {
	...
	public void saveConfig(String year, String semester, String name, Map<String, String> content) {
		...
		ProcessAdministration.getInstance().changedDeadlines(name,semester,iYear);
	...
	/**
	 * This function is used to get log-entries for a specified period
	 * @param year : Integer of the year (e.g. 2011)
	 * @param semester : String of the semester (SS / WS)
	 * @param type : String of the name (BA / MA)
	 * @param fromDate : Date of the period beginning
	 * @param untilDate : Date of the period ending
	 * 
	 * @return Collection<String[]> with log-entries
	 */
	@Override
	public Collection<String[]> getLogEntries(int year, String semester, String type, Date fromDate, Date untilDate){
			...
			return loggingReader.getLog(fromDate, untilDate);
	}
